...
describe("PlanGenerationSection Component", () => {
    ...
    it("renders correctly with title and description", () => {
        render(<PlanGenerationSection onGeneratePlan={mockGeneratePlan} isGenerating={false} />);
    ...
    it("shows loading state when isGenerating is true", () => {
        render(<PlanGenerationSection onGeneratePlan={mockGeneratePlan} isGenerating={true} />);
    ...
    it("has appropriate accessibility attributes", () => {
        render(<PlanGenerationSection onGeneratePlan={mockGeneratePlan} isGenerating={false} />); // Check if section has proper ARIA labeling
