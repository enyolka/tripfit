...
describe("GeneratePlanButton Component", () => {
    ...
    it("has proper accessibility attributes", () => {
        // Test regular state
        const { rerender } = render(<GeneratePlanButton onGeneratePlan={mockGeneratePlan} isLoading={false} />);

        let button = screen.getByRole("button");
        expect(button).toHaveAttribute("aria-busy", "false");

        // Test loading state
        rerender(<GeneratePlanButton onGeneratePlan={mockGeneratePlan} isLoading={true} />);
